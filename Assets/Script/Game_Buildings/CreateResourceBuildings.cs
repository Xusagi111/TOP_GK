...
namespace Building
{
    ...
    {
        [field: SerializeField] public BaseWarehouse AddResourceWarhouse { get; protected set; }
        [field: SerializeField] public BaseWarehouse GetResource { get; protected set; }
